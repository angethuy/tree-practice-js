...
describe("Tree", () => {
    ...
    it("adds in correct order", () => {
        expect(treeWithNodes.root.value).toEqual("Peter");
        expect(treeWithNodes.root.left.value).toEqual("Paul");
        expect(treeWithNodes.root.left.left.value).toEqual("Mary");
        expect(treeWithNodes.root.right.value).toEqual("Karla");
        expect(treeWithNodes.root.right.right.value).toEqual("Ada");
        expect(treeWithNodes.root.right.right.right.value).toEqual("Kari");
    });
    ...
    describe("height", () => {
        ...
        it("will report the height of an unbalanced tree", () => {
            ...
            expect(myTree.root.right.value).toEqual("Simon")
            expect(myTree.root.right.right.value).toEqual("Devin")
            expect(myTree.root.right.right.right.value).toEqual("Janice")
            expect(myTree.root.right.right.right.right.value).toEqual("Lauren")
